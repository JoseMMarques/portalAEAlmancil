    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diretor', models.CharField(max_length=254, verbose_name='Diretor(a) do Agrupamento')),
                ('coordenador', models.CharField(max_length=254, verbose_name='Coordenador(a) de estabelecimento')),
            ],
            options={
                'verbose_name': 'Escola',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=20, null=True, verbose_name='Turma')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, help_text='Deixar em branco para criar um slug automático e único.', max_length=255, unique=True)),
                ('school_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school_structure.schoolyear', verbose_name='Ano Letivo')),
                ('secretary', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='secretary_dt', to='accounts.teacher', verbose_name='Secretário de Turma')),
                ('teacher_dt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teacher_dt', to='accounts.teacher', verbose_name='Diretor de Turma')),
